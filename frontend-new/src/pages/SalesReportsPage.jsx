                    ...
                    <table className="page-table">
                        <thead>
                            <tr>
                                ...
                                <th className="text-right print:text-black py-2 px-4">Taxable</th>
                                <th className="text-right print:text-black py-2 px-4">CGST</th>
                                <th className="text-right print:text-black py-2 px-4">SGST</th>
                                <th className="text-right print:text-black py-2 px-4">IGST</th>
                                <th className="text-right print:text-black py-2 px-4">Total</th>
                            </tr>
                        </thead>
                        <tbody>
                            {reportData.length > 0 ? (
                                <>
                                    {reportData.map((row) => (
                                        <tr key={row.sno} className="border-b border-gray-200 hover:bg-gray-50 print:hover:bg-transparent">
                                            ...
                                            <td className="py-2 px-4 text-right font-semibold text-gray-900 print:text-black">₹{row.taxableAmount || (row.rate * row.qty)}</td>
                                            <td className="py-2 px-4 text-right font-semibold text-gray-900 print:text-black">₹{row.cgst || 0}</td>
                                            <td className="py-2 px-4 text-right font-semibold text-gray-900 print:text-black">₹{row.sgst || 0}</td>
                                            <td className="py-2 px-4 text-right font-semibold text-gray-900 print:text-black">₹{row.igst || 0}</td>
                                            <td className="py-2 px-4 text-right font-semibold text-gray-900 print:text-black">₹{row.total || (row.rate * row.qty)}</td>
                                        </tr>
                                    ))}
                                    ...
                                    <tbody>
                                        {reportData.map((row) => (
                                            <tr key={row.sno} className="border-b border-gray-200">
                                                ...
                                                <td className="py-2 px-3 text-right text-gray-900 text-sm">₹{row.total || (row.rate * row.qty)}</td>
                                            </tr>
                                        ))}
                                        <tr className="bg-gray-100 border-t-2 border-gray-300">
