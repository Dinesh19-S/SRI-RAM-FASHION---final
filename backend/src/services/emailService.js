...
<head>
  ...
  <title>${title} - Sri Ram Fashions</title>
</head>
<body style="margin:0;padding:0;background-color:#f8fafc;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased;">
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#f8fafc;padding:40px 20px;">
    <tr><td align="center">
      ...
      <!-- Main container -->
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:24px;overflow:hidden;box-shadow:0 10px 50px rgba(0,0,0,0.05);border:1px solid #e2e8f0;">
        ...
        <tr>
          <td style="background:#0f172a;padding:40px 40px 30px;text-align:center;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
              <tr><td align="center">
                <div style="width:64px;height:64px;background:rgba(255,255,255,0.05);border-radius:20px;margin:0 auto 20px;line-height:64px;font-size:32px;border:1px solid rgba(255,255,255,0.1);">
                  🏢
                </div>
                <h1 style="margin:0;font-size:26px;font-weight:800;color:#ffffff;letter-spacing:3px;text-transform:uppercase;">SRI RAM FASHIONS</h1>
                <p style="margin:8px 0 0;font-size:12px;text-transform:uppercase;letter-spacing:5px;color:rgba(255,255,255,0.4);font-weight:600;">Shop Management System</p>
              </td></tr>
            </table>
          </td>
        </tr>
        ...
        <!-- ===== ACCENT BANNER ===== -->
        <tr>
          <td style="background:linear-gradient(135deg,${accentFrom},${accentTo});padding:24px 40px;text-align:center;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
              <tr><td align="center">
                <h2 style="margin:0;font-size:22px;font-weight:800;color:#ffffff;letter-spacing:0.5px;">${icon} ${title}</h2>
                ${subtitle ? `<p style="margin:6px 0 0;font-size:14px;color:rgba(255,255,255,0.9);font-weight:500;">${subtitle}</p>` : ''}
              </td></tr>
            </table>
          </td>
        </tr>
        ...
        <!-- ===== FOOTER ===== -->
        <tr>
          <td style="padding:30px 40px;text-align:center;background:#f8fafc;border-top:1px solid #e2e8f0;">
            <p style="margin:0 0 6px;font-size:12px;color:#64748b;line-height:1.6;font-weight:500;">
              Sri Ram Fashions • Quality & Professionalism
            </p>
            <p style="margin:0;font-size:11px;color:#94a3b8;">
              © ${year} Sri Ram Fashions. All archival data is secure.
            </p>
          </td>
        </tr>
...
const detailRow = (label, value, options = {}) => {
  const { bold = false, color = '#1e293b', large = false } = options;
  return `
    <tr>
      <td style="padding:14px 20px;border-bottom:1px solid #f1f5f9;color:#64748b;font-size:13px;width:40%;font-weight:500;">${label}</td>
      <td style="padding:14px 20px;border-bottom:1px solid #f1f5f9;color:${color};font-size:${large ? '20px' : '15px'};font-weight:${bold || large ? '800' : '600'};text-align:right;">${value}</td>
    </tr>`;
};
